...
class ArrTypeG2 extends Type implements \Iterator, Monoid, Semigroup {
	...
	public function concat(Semigroup $arr): ArrType {
		return new self(array_merge($this->extract(), $arr->extract()));
	}
	...
	public function sum() {
		return static::of(array_sum($this->value));
	}
