...
use function lray138\GAS\Arr\mergeLeft;
...
it('merges two indexed arrays', function () {
    ...
    $array1 = [1, 2, 3];
    $array2 = [4, 5, 6];
    $result1 = mergeLeft($array1, $array2);
    expect($result1)->toBe([1, 2, 3, 4, 5, 6]);
});
...
it('merges an indexed array with an associative array', function () {
    ...
    $result2 = mergeLeft($indexedArray, $assocArray);
    expect($result2)->toBe([1, 2, 3, 'name' => 'John', 'age' => 30]);
});
